...
import com.example.seizuredetectionapp.utils.FilterUtils;
...
public class ScannerViewModel extends AndroidViewModel {
     ...
     * {@link com.example.seizuredetectionapp.ScannerActivity} will try to start scanning.
     */
    public void refresh() {
     ...
     *
     * @param uuidRequired if true, the list will display only devices with STRapp Service UUID
