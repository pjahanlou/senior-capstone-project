...
import com.example.seizuredetectionapp.databinding.ActivityBleActivityBinding;
...
public class BleActivity extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        viewModel.getSensorState().observe(this,
                pressed -> binding.sensorState.setText(pressed ?
    ...
    private void onConnectionStateChanged(final boolean connected) {
        ...
        if (!connected) {
            ...
            binding.sensorState.setText(R.string.button_unknown);
        }
    }
}
