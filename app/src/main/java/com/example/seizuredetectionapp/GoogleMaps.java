...
public class GoogleMaps extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFusedLocationProviderClient = LocationServices.getFusedLocationProviderClient(GoogleMaps.this);
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                placesClient.findAutocompletePredictions(predictionsRequest).addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        ...
                        Log.i("prediction task", "prediction fetching task unsuccessful");
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        SettingsClient settingsClient = LocationServices.getSettingsClient(GoogleMaps.this);
        Task<LocationSettingsResponse> task = settingsClient.checkLocationSettings(builder.build());

        task.addOnSuccessListener(GoogleMaps.this, locationSettingsResponse -> getDeviceLocation());

        task.addOnFailureListener(GoogleMaps.this, e -> {
            if (e instanceof ResolvableApiException) {
                ResolvableApiException resolvable = (ResolvableApiException) e;
                try {
                    resolvable.startResolutionForResult(GoogleMaps.this, 51);
                ...
                .addOnCompleteListener(new OnCompleteListener<Location>() {
                    ...
                    public void onComplete(@NonNull Task<Location> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(GoogleMaps.this, "unable to get last location", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
